    ...
    <div class="success-modal-overlay" @click.self="$emit('close')">
      <div class="success-modal">
        <div class="modal-content">
          ...
          <h2 class="success-title success-color">Order confirmed</h2>
          <p class="success-message">
           Your order has been successfully registerd. You will receive a confirmation call as soon as possible. 
          </p>
          ...
          <div class="order-details">
            ...
            <div class="order-summary">
              ...
              <div class="summary-item">
                ...
                <span class="item-value">{{ orderData.quantite }} piece(s)</span>
              </div>
              <div class="summary-item">
          ...
          <div class="next-steps">
            <h3 class="steps-title">Next Step:</h3>
            <div class="steps-list">
              <div class="step-item">
                <div class="step-number bg-orange">1</div>
                <div class="step-text">You will receive a confirmation call within 30 minutes</div>
              </div>
              <div class="step-item ">
                <div class="step-number bg-orange">2</div>
                <div class="step-text">Preparing your order (1-2h)</div>
              </div>
              <div class="step-item">
                <div class="step-number bg-orange">3</div>
                <div class="step-text">Delivery according to the option chosen</div>
              </div>
            </div>
          </div>
