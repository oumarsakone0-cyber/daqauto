    ...
    <div class="product-info">
      ...
      <div class="product-price-section">
        <div class="price-range">
         ...
         <span class="text-gray-400">( FOB )</span> 
        </div>
      ...
      <div class="order-section">
        <div class="quantity-selector" >
          ...
          <div class="quantity-available">{{ product.stock }} Parts disponibles</div>
        </div>
        
        <div class="total-price">
          <span class="total-label">Total:</span>
          <span class="total-value primary-color">{{ formatPrice(calculateTotal()) }}</span> <span class="text-gray-400">( FOB )</span> 
        </div>
        
        
        <div class="action-buttons flex-1">
          ...
          <button class="chat-btn" @click="$emit('openChat')">
           ...
           -->
          <button class="btn-degrade-orange flex-1" @click="$emit('startOrder')">
            <svg width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2">
